				 ...
				 if (args.length > 1) {
					 Player target = Bukkit.getServer().getPlayer(args[0]);
						...
						if (target.getName() == p.getName()) {
							target.sendMessage(ChatColor.BLUE + "[" + ChatColor.BLUE + "From: " + ChatColor.DARK_AQUA + "InfoBot" + ChatColor.BLUE + "]> " + ChatColor.WHITE + "Just tell me...... What is so important that you gone text yourself??");
							return true;
						}
