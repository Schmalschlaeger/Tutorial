...
public class Main extends JavaPlugin {
	...
	public static String banPerms = "simpleEssentials.command.kick";
	public static String unbanPerms = "simpleEssentials.command.kick";
	...
	public void onEnable() {
		...
		getCommand("unban").setExecutor(new KickBanCommand());
