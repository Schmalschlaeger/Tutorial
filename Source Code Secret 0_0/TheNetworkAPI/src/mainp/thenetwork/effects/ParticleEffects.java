...
import mainp.thenetwork.effects.ReflectionUtil.DynamicPackage;
import mainp.thenetwork.effects.ReflectionUtil.FieldEntry;
 ...
 * 
 * This library was created by @jusjus112 based on content related to particles of @microgeek (names and packet values) and allows you to display all Minecraft particle effects on a Bukkit server
 * 
...
public enum ParticleEffects {
	 ...
	 * @return 
	 */
	public EntityEffect display(Location loc, float offsetX, float offsetY, float offsetZ, float speed, int amount) {
	...
	public void sendToPlayer(Location location, Location location2, int i,
