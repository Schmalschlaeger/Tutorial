...
/**
 * @Param Make a custom config, with this small class
 * @Param Create a new File, with the name of the file! !NOT CONFIG NAME!
 * Then make a new Config with the name of the config! .yml
 */
public class FileManager{
	...
	public FileManager(String filename, MainManager instance) {
	...
	public FileManager(File folder, String filename, MainManager instance) {
		if (!filename.endsWith(".yml")) {
			filename += ".yml";
		}
		this.FILENAME = filename;
